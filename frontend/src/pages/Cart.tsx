...
const [createCheckoutSession, { loading }] =
  useMutation<CreateCheckoutSessionData>(
...
if (items.length === 0) {
return ( <main className="flex min-h-screen items-center justify-center bg-[#f8f5ef] px-6"> <div className="text-center"> <h1 className="text-4xl font-black text-[#2d3a2f]">
...
return ( <main className="min-h-screen bg-[#f8f5ef] px-6 py-16"> <div className="mx-auto max-w-7xl"> <h1 className="text-5xl font-black text-[#2d3a2f]">
Your cart </h1>
